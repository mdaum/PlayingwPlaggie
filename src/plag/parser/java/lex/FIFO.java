...
class FIFO {
  ...
  public java_cup.runtime.Symbol get() throws java.io.IOException, LexerException {
    if (isEmpty())
      put(getter.next());
    ASSERT(!isEmpty());
  ...
  public java_cup.runtime.Symbol peek(int i) throws java.io.IOException, LexerException {
    while (i >= size())
      put(getter.next());
    int index = start+i;
  ...
  abstract static class Getter {
      ...
      throws java.io.IOException, LexerException;
  }
